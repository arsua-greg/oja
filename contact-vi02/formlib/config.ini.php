...
define('INQ_TO_MAIL', "contact@oja.jp");//管理者宛先contact@oja.jp
...
define('INQ_ADMIN_MAIL_SUBJECT1', "ホームページからの問い合わせ from ベトナム語ページ");//管理者メールタイトル
define('INQ_USER_MAIL_SUBJECT1', "Cám ơn đã liên hệ với chúng thôi");//ユーザーメールタイトル

define('INQ_ADMIN_MAIL_SUBJECT2', "ホームページからの資料請求 from ベトナム語ページ");//管理者メールタイトル
define('INQ_USER_MAIL_SUBJECT2', "Cám ơn bạn đã yêu cầu bài viết");//ユーザーメールタイトル
