...
define('INQ_TO_MAIL', "contact@oja.jp");//管理者宛先 info@n-effect.co.jp
...
define('INQ_ADMIN_MAIL_SUBJECT1', "ホームページからの問い合わせ from 中国語ページ");//管理者メールタイトル
define('INQ_USER_MAIL_SUBJECT1', "谢谢你的咨询");//ユーザーメールタイトル

define('INQ_ADMIN_MAIL_SUBJECT2', "ホームページからの資料請求 from 中国語ページ");//管理者メールタイトル
define('INQ_USER_MAIL_SUBJECT2', "谢谢您对我们资料的需求");//ユーザーメールタイトル
