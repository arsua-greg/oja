...
class MySnedMail{
	...
	*/
	public function set_body($val){
		...
		$this->mail_body  = mb_convert_encoding($this->mail_body,"JIS",MOJI_CODE);
	}
...
//		$this->mail_header .= "From: ".mb_encode_mimeheader(mb_convert_encoding($this->to_name,"EUC-JP",MOJI_CODE),"ISO-2022-JP",MOJI_CODE)."<".$this->to_mail.">\n";
		$this->mail_header .= "From: ".mb_encode_mimeheader($this->from_name,"ISO-2022-JP","B","\n")."<".$this->from_mail.">\n";
//		$this->mail_header .= "To: ".$this->to_mail."\n";
		$this->mail_header .= "Cc: \n";
		$this->mail_header .= "Bcc: ".$this->bcc_mail."\n";
		$this->mail_header .= "MIME-Version: 1.0\n";
		$this->mail_header .= "Content-Type: text/plain; charset=iso-2022-jp\n";
		$this->mail_header .= "Content-Transfer-Encoding: 7bit";

		$this->mail_title = mb_encode_mimeheader($val,"ISO-2022-JP","B","\n");
