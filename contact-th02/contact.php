...
class FormModel{
	...
	public function check()
	{
		...
		setcookie('TOKEN', RANDOM_TOKEN, time()+3600, "/contact-th02/", COOKIE_DOMAIN);
		$this->post['TOKEN'] = RANDOM_TOKEN;
	...
	public function mailsend()
	{
		...
		setcookie('TOKEN', RANDOM_TOKEN, time()-9000, "/contact-th02/", COOKIE_DOMAIN);
	...
	private function errorcheck(&$post)
	{
		...
		{
			$error .= "Please input your address.<br />\n";
		}
		else
		{
			$strmaxlenByte = 100;
