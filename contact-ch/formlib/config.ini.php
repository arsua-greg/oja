...
define('INQ_TO_MAIL', "info@n-effect.co.jp");//管理者宛先
...
define('INQ_ADMIN_MAIL_SUBJECT1', "ホームページからの問い合わせ");//管理者メールタイトル
define('INQ_USER_MAIL_SUBJECT1', "Thank you for contacting us [Osaka Japanese Language Academy]");//ユーザーメールタイトル

define('INQ_ADMIN_MAIL_SUBJECT2', "ホームページからの資料請求");//管理者メールタイトル
define('INQ_USER_MAIL_SUBJECT2', "Thank you for contacting us [Osaka Japanese Language Academy]");//ユーザーメールタイトル
