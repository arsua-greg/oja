...
define('INQ_ADMIN_FROM_NAME', "大阪日本語アカデミー");

define('INQ_ADMIN_MAIL_SUBJECT1', "ホームページからの問い合わせ from 日本語ページ");//管理者メールタイトル
define('INQ_USER_MAIL_SUBJECT1', "お問合せありがとうございました[OJA大阪日本語アカデミー]");//ユーザーメールタイトル

define('INQ_ADMIN_MAIL_SUBJECT2', "ホームページからの資料請求 from 日本語ページ");//管理者メールタイトル
define('INQ_USER_MAIL_SUBJECT2', "資料のご請求ありがとうございました[OJA大阪日本語アカデミー]");//ユーザーメールタイトル
